...
package io.huayu.springboot.framework.util;
...
public class PrintApplicationInfo {
    ...
    public static void printTip(){
        ...
        tip.append("                                                                                  \n");
        tip.append("                               !!!准备工作!!!                                      \n");
        tip.append(" 1.请先在MySQL中创建数据库，默认数据库名称为：demo                        \n");
        tip.append(" 2.数据库脚本在项目docs/mysql.sql                                       \n");
    ...
    public static void print(ConfigurableApplicationContext context){
        ...
        log.info("SpringBoot-demo project start success...........");
